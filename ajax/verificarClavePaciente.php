	...
	if(!Persona::VerificarPIN($rut,$codigo)){
		...
		$_SESSION['idPaciente'] = $id;
             ...
             /*
               ...
               $_SESSION['hora'] = time();
               Consulta::InsertarAlternativo($_SESSION['fechaConsulta'],$_SESSION['hora'],$_SESSION['idMedicoLog'][0],$_SESSION['idPaciente'],$_SESSION['idLugar']);
             ...
             $id_consulta = Consulta::SeleccionarID($_SESSION['idMedicoLog'][0],$_SESSION['hora'], $_SESSION['idPaciente'], $_SESSION['fechaConsulta'], $_SESSION['idLugar']);
